...
#define BLYNK_TEMPLATE_ID "TMPL3RzQEIzHv"
#define BLYNK_TEMPLATE_NAME "water level"
#define BLYNK_AUTH_TOKEN "175qmY-lmO1vWletcXtITUu3p_KQ7Pwf"

// Your WiFi credentials.
// Set password to "" for open networks.
char ssid[] = "ROBUKITS";   //WiFi Name
char pass[] = "Prince@7053";   //WiFi Password

//Set Water Level Distance in CM
int emptyTankDistance = 70 ;  //Distance when tank is empty
int fullTankDistance =  20 ;  //Distance when tank is full (must be greater than 25cm)
